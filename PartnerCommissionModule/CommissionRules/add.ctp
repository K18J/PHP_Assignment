<?php
$breadcrumb = [__("Settings"), __("Partners"), ["link" => $this->Url->build(['controller' => 'CommissionRules', 'action' => 'index']), "text" => __("Commission Rules")], __("Add")];
              ...
              <div class="kt-form__actions">
                <div class="row">
                  <div class="col-lg-12 text-center">
                    <button type="submit" class="btn btn-success btn-sm"><?php echo __('Save'); ?></button>
